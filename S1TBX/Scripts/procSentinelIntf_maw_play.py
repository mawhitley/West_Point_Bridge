...
# script
global baseSNAP
baseSNAP = '/home/mawhitley/snap/bin/gpt '
global extDEM
extDEM=''
global subSwath
subSwath = 'IW1'
...
def backGeocoding(inData1,inData2,td2,dem=''):
    ...
    if dem != '':
        calFlag = calFlag + '-PdemName=\"External DEM\" -PexternalDEMFile=%s -PmaskOUtAreaWithoutElevation=\"false\"' % dem
    else:
...
if os.path.exists(master) and os.path.exists(slave):
    ...
    # print '\n\n'
    unwOut = phaseUnwrap(topoOut,td2)
    print '\n\n'
